...
1. Calcula las siguientes derivadas
    ...
    $f(x) =x^2+3x+\frac{1}{x^2}$
    
    $f(x) =\frac{x^3}{3}+\frac{3}{x^3}$
    
    
    $f(x) =\frac{3}{x^2}+\frac{5}{x^4}$
...
2. Calcula las siguientes derivadas
    ...
    $D_x\left[\frac{2x}{x+3}\right]$
    
    $D_x\left[\frac{x}{x-1}\right]$
    
    $D_x\left[\frac{x^2+2x+1}{x^2-2x+1}\right]$
    
    $D_x\left[\frac{x^2-a^2}{x^2+a^2}\right]$
    
    $D_x\left[\frac{4-3x-x^2}{x-2}\right]$
    
    $D_x\left[\frac{x^3-8}{x^3+8}\right]$
    
    $D_x\left[\frac{2x+1}{x+5}(3x-1)\right]$
    
    $D_x\left[\frac{x^3+1}{x^2+3}(x^2-2x^{-1}+1)\right]$
    
    $D_x\left[\frac{1}{6x^3}\right]$
    
    $D_x\left[x^5-\frac{1}{15x^5}\right]$
    
    $D_x\left[(2x^2+x+1)^3\right]$
    
    $D_x\left[(2x^2+3)(x-5)(3x+2)\right]$
    
    $D_x\left[(3x+2)^2(x^2-1)\right]$
    
    $D_x\left[(3x^3+x^{-3})(x+3)(x^2-5)\right]$



3. Calcule las primeras tres derivadas del ejercicio 1 (sólo pares) 

4. Calcule las primeras tres derivadas del ejercicio 2 (sólo impares) 


## Derivadas de Funciones Trigonométricas

1. Calcula las siguientes derivadas trigonométricas recordar que
...
2. Calcula las siguientes derivadas
    ...
    $f\left(x\right)=\frac{\sin x}{1-2\cos x}$, encontrar $f^{1}\left(x\right)$
    
    $\frac{d^3}{dx^3}\left(2\sin x+3\cos x-x^3\right)$
    
    $f\left(x\right)=\tan x \sec x$
    
    
    $f\left(x\right)=3\sin x$
    
    
    $f\left(x\right)=4\sec -3\csc x$
    
    
    $f\left(x\right)=5x\sin x+2\cos x$
    
    
    $f\left(x\right)=\frac{2}{3}\sin x\cos x$
    
    
    $f\left(x\right)=x^2\sin x+2x\cos x$
    
    
    $f\left(x\right)=x^2\cos x+2x\sin x-4\cos x$
    
    
    $f\left(x\right)=x^3-x^2\cos x+3x\sin x+2\cos x$
    
    
    $f\left(x\right)=3\sec x \tan x$
...
3. Realice las operaciones indicadas
    ...
    $D_x[\frac{2\cos x}{x+1}]$
    
    $D_x[\frac{\sin x}{1-\cos x}]$
    
    $D_x[\frac{\tan x}{\cos x-4}]$
    
    $D_x[\frac{x+4}{\cos x}]$
    
    $D_x[\frac{\sin x-1}{\cos x+1}]$
    
    $D_x[(x-\sin x)(x+\cos x)]$
    
    $D_x[(x^2+\cos x)(2x-\sin x)]$
    
    $D_x[\frac{\tan x +1}{\tan x-2}]$
    


4. Calcula las siguientes derivadas de los órdenes indicados:
    ...
    $D^5[-1\frac{1}{5}x^{-5}+\frac{1}{7}x^3]$
    
    $D^5[\frac{1}{x^2}+\frac{2}{3x^4}]$
    
    $D^2[\frac{\sqrt{2}}{3}(x^3-x^9)]$
    
    $D^3[\frac{x^3-8}{x^3+8}]$
    
    $D^2[\frac{7x+6}{4x+7}\left(\frac{3x}{2}+1\right)]$
    
    $D^5[\frac{\sqrt{5}}{5}\left(x^5-2x^4+3x^4-4x^2+5x-\frac{1}{x}\right)]$
