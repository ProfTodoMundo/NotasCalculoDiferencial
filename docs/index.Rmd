...
**Para las siguientes funciones determina su dominio e imagen**
...
**Para las siguientes funciones determina su dominio, imagen y función**


¡Por supuesto! Aquí tienes ejemplos de funciones de los tipos que mencionaste en tres niveles de complejidad, junto con una función fraccional:
  ...
  15. $f(x) = \sqrt{4x^2 - 4}$
  16. $f(x) = \sqrt{e^{2x} + 2x + 1}$
  17. $f(x) = \sqrt{\sin(x^2) + \cos(2x)}$
  ...
  25. $f(x) = \frac{e^{2x} + 2x + 1}{x + 1}$
  26. $f(x) = \frac{\sin(x^2) + \cos(x)}{x}$
