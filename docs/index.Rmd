...
Para descargar la tarea dar [click aquí](Tarea2.pdf)

# 4. Límite de Funciones



1. Resolver los siguientes lìmites

    a. $lim_{x\to 2}\frac{x^2 - 1}{x-1}$
    b. $lim_{x\to -3}\frac{2x+5}{x+3}$
    c. $lim_{x\to 1}\frac{3x^2 - 4x - 3}{x-1}$
    d. $lim_{x\to 0}\frac{2x^2 + 3x}{x}$
    e. $lim_{x\to -1}\frac{x^3 - 1}{x^2 - 1}$
    f. $lim_{x\to 3}\frac{x^2 + 2x - 3}{x-3}$
    g. $lim_{x\to -2}\frac{3x+4}{x+2}$
    h. $lim_{x\to 2}\frac{x^3 - 2x^2 - x + 2}{x-2}$
    i. $lim_{x\to -4}\frac{2x^2 - 9x - 5}{x+4}$

2. Resolver los siguientes lìmites

    a. $lim_{x\to 3}\frac{x}{x-3}$
    b. $lim_{x\to -2}\frac{x^2}{x+2}$
    c. $lim_{x\to 1}\frac{2x}{x-1}$
    d. $lim_{x\to -1}\frac{x^3}{x+1}$
    e. $lim_{x\to 5}\frac{4x}{x-5}$
    f. $lim_{x\to 0}\frac{x}{x-0}$
    g. $lim_{x\to 4}\frac{x^2}{x-4}$
    h. $lim_{x\to 2}\frac{3x}{x-2}$
    i. $lim_{x\to -3}\frac{x^3}{x+3}$

3. Resolver los siguientes lìmites

    a. $lim_{x\to -2}\frac{3x}{4-x^2}$
    
    b. $lim_{x\to 1}\frac{x}{5-x^2}$
    
    c. $lim_{x\to 0}\frac{2x}{3-x^2}$
    
    d. $lim_{x\to -1}\frac{5x}{4-x^2}$
    
    e. $lim_{x\to 2}\frac{x}{x^2-5}$
    
    f. $lim_{x\to 3}\frac{4x}{5-x^2}$
    
    g. $lim_{x\to -1}\frac{2x}{x^2-9}$
    
    h. $lim_{x\to 0}\frac{3x}{x^2+1}$
    
    i. $lim_{x\to -1}\frac{6x}{x^2-4}$

4. Resolver los siguientes lìmites


    a. $lim_{x\to -1}\frac{x+3}{x^2-1}$
    
    b. $lim_{x\to 2}\frac{x+4}{x^2-4}$
    
    c. $lim_{x\to 4}\frac{x+1}{x^2-16}$
    
    d. $lim_{x\to 2}\frac{x+5}{x^2-4}$
    
    e. $lim_{x\to 6}\frac{x+6}{x^2-36}$
    
    f. $lim_{x\to 5}\frac{x+4}{x^2-25}$
    
    g. $lim_{x\to 3}\frac{x+2}{x^2-9}$
    
    h. $lim_{x\to 8}\frac{x+5}{x^2-64}$
    
    i. $lim_{x\to 9}\frac{x+6}{x^2-81}$


5. Resolver los siguientes lìmites

    a. $lim_{x\to 2}\frac{\sqrt{4+x^2}}{x}$
    
    b. $lim_{x\to 1}\frac{\sqrt{1+x^2}}{x}$
    
    c. $lim_{x\to 0}\frac{\sqrt{3+x^2}}{x}$
    
    d. $lim_{x\to -1}\frac{\sqrt{2+x^2}}{x}$
    
    e. $lim_{x\to 4}\frac{\sqrt{5+x^2}}{x}$
    
    f. $lim_{x\to 3}\frac{\sqrt{9+x^2}}{x}$
    
    g. $lim_{x\to 1}\frac{\sqrt{1+x^2}}{x}$
    
    h. $lim_{x\to 0}\frac{\sqrt{16+x^2}}{x}$
    
    i. $lim_{x\to -2}\frac{\sqrt{4+x^2}}{x}$

6. Resolver los siguientes lìmites

    a. $lim_{x\to 2}\frac{\sqrt{x^2-4}}{x-2}$
    
    b. $lim_{x\to 4}\frac{\sqrt{x^2-16}}{x-4}$
    
    c. $lim_{x\to 1}\frac{\sqrt{x^2-1}}{x-1}$
    
    d. $lim_{x\to 5}\frac{\sqrt{x^2-25}}{x-5}$
    
    e. $lim_{x\to -2}\frac{\sqrt{x^2-4}}{x+2}$
    
    f. $lim_{x\to 3}\frac{\sqrt{x^2-9}}{x-3}$
    
    g. $lim_{x\to 4}\frac{\sqrt{x^2-16}}{x-4}$
    
    h. $lim_{x\to 1}\frac{\sqrt{x^2-1}}{x-1}$
    
    i. $lim_{x\to 5}\frac{\sqrt{x^2-25}}{x-5}$


7. Resolver los siguientes lìmites

    a. $lim_{x\to 0}\left(\frac{1}{x^2}-\frac{1}{x^3}\right)$
    
    b. $lim_{x\to 0}\left(\frac{1}{x}-\frac{1}{x^3}\right)$
    
    c. $lim_{x\to 0}\left(\frac{1}{x^2}-\frac{1}{x^4}\right)$
    
    d. $lim_{x\to 0}\left(\frac{1}{x}-\frac{1}{x^4}\right)$
    
    e. $lim_{x\to 0}\left(\frac{1}{x^3}-\frac{1}{x^4}\right)$
    
    f. $lim_{x\to 0}\left(\frac{1}{x}-\frac{1}{x^2}\right)$
    
    g. $lim_{x\to 0}\left(\frac{1}{x^2}-\frac{1}{x^4}\right)$
    
    h. $lim_{x\to 0}\left(\frac{1}{x}-\frac{1}{x^4}\right)$
    
    i. $lim_{x\to 0}\left(\frac{1}{x^3}-\frac{1}{x^4}\right)$


8. Resolver los siguientes lìmites

    a. $lim_{x\to 0}\frac{3x^2-2x^3}{4x^3+x^2}$
    
    b. $lim_{x\to 0}\frac{x^3-2x^2}{3x^4-5x^2}$
    
    c. $lim_{x\to 0}\frac{x^4-4x^3}{5x^5-2x^2}$
    
    d. $lim_{x\to 0}\frac{6x^3-5x^4}{x^2-3x^5}$
    
    e. $lim_{x\to 0}\frac{x^3-6x^4}{2x^5+4x^2}$
    
    f. $lim_{x\to 0}\frac{x^3-2x^4}{3x^5-5x^2}$
    
    g. $lim_{x\to 0}\frac{x^4-4x^5}{5x^6-2x^3}$
    
    h. $lim_{x\to 0}\frac{6x^3-5x^4}{x^2-3x^6}$
    
    i. $lim_{x\to 0}\frac{x^4-6x^5}{2x^6+4x^3}$


9. Resolver los siguientes lìmites

    a. $lim_{x\to 2}\left(\frac{1}{x}-\frac{3}{x^2-4}\right)$
    
    b. $lim_{x\to 3}\left(\frac{2}{x+1}-\frac{4}{x^2-9}\right)$
    
    c. $lim_{x\to 1}\left(\frac{5}{x-2}-\frac{2}{x^2-1}\right)$
    
    d. $lim_{x\to -2}\left(\frac{1}{x+2}-\frac{2}{x^2-1}\right)$
    
    e. $lim_{x\to -1}\left(\frac{4}{x+1}-\frac{1}{x^2-4}\right)$
    
    f. $lim_{x\to -3}\left(\frac{2}{x+1}-\frac{4}{x^2-9}\right)$
    
    g. $lim_{x\to 2}\left(\frac{5}{x-2}-\frac{2}{x^2-1}\right)$
    
    h. $lim_{x\to -2}\left(\frac{1}{x+2}-\frac{2}{x^2-1}\right)$
    
    i. $lim_{x\to -1}\left(\frac{4}{x+1}-\frac{1}{x^2-4}\right)$


10. Resolver los siguientes lìmites

    a. $lim_{x\to 1}\frac{x^3+5x^2+6x}{x^2-3x+2}$
    
    b. $lim_{x\to 3}\frac{x^3+8x^2+12x}{x^2-4x+3}$
    
    c. $lim_{x\to 5}\frac{x^3+4x^2+3x}{x^2-2x-15}$
    
    d. $lim_{x\to 2}\frac{x^3+10x^2+25x}{x^2-5x+6}$
    
    e. $lim_{x\to 1}\frac{x^3+7x^2+10x}{x^2-3x+2}$
    
    f. $lim_{x\to 3}\frac{x^3+8x^2+12x}{x^2-4x+3}$
    
    g. $lim_{x\to -3}\frac{x^3+4x^2+3x}{x^2-2x-15}$
    
    h. $lim_{x\to 2}\frac{x^3+10x^2+25x}{x^2-5x+6}$
    
    i. $lim_{x\to 2}\frac{x^3+7x^2+10x}{x^2-3x+2}$

11. Resolver los siguientes lìmites

    a. $lim_{x\to -5}\frac{3}{x^2+7x+10}$
    
    b. $lim_{x\to 3}\frac{2}{x^2-6x+9}$
    
    c. $lim_{x\to -4}\frac{4}{x^2+9x+20}$
    
    d. $lim_{x\to 3}\frac{6}{x^2-0x+21}$
    
    e. $lim_{x\to -5}\frac{7}{x^2+5x}$
    
    f. $lim_{x\to 3}\frac{4}{x^2+4x-21}$
    
    g. $lim_{x\to 9}\frac{2}{x^2+8x-9}$
    
    h. $lim_{x\to 3}\frac{6}{x^2+8x-15}$
    
    i. $lim_{x\to 0}\frac{7}{x^2+3x}$
    

12. Resolver los siguientes lìmites


    a. $lim_{x\to 4}\frac{\sqrt{x}-3}{x-4}$
    
    b. $lim_{x\to 2}\frac{\sqrt{x}-2}{x-4}$
    
    c. $lim_{x\to 4}\frac{\sqrt{x}-2}{x^2-16}$
    
    d. $lim_{x\to 1}\frac{\sqrt{x}+1}{x^2-1}$
    
    e. $lim_{x\to 4}\frac{\sqrt{x}+2}{x^3-64}$
    
    f. $lim_{x\to 4}\frac{\sqrt{x}-2}{x-4}$
    
    g. $lim_{x\to 4}\frac{\sqrt{x}-2}{x^2-16}$
    
    h. $lim_{x\to 4}\frac{\sqrt{x}+1}{x^2-12x+32}$
    
    i. $lim_{x\to 4}\frac{\sqrt{x}+2}{x^2-64}$
    

13. Resolver los siguientes lìmites

    a. $lim_{x\to -2}\frac{x^2+6x+9}{x+2}$
    
    b. $lim_{x\to 1}\frac{x^2+3x+2}{x-1}$
    
    c. $lim_{x\to -1}\frac{x^2+5x+6}{x+1}$
    
    d. $lim_{x\to -4}\frac{x^2+2x+1}{x+4}$
    
    e. $lim_{x\to -2}\frac{x^2+7x+12}{x+2}$
    
    f. $lim_{x\to 1}\frac{x^2+3x+2}{x-1}$
    
    g. $lim_{x\to -1}\frac{x^2+5x+6}{x+1}$
    
    h. $lim_{x\to -4}\frac{x^2+2x+1}{x+4}$
    
    i. $lim_{x\to -2}\frac{x^2+7x+12}{x+2}$


14. Resolver los siguientes lìmites

    
    a. $lim_{x\to 16}\frac{x-11}{\sqrt{x}-4}$
    
    b. $lim_{x\to 4}\frac{x-8}{\sqrt{x}-2}$
    
    c. $lim_{x\to 1}\frac{x-10}{\sqrt{x}+1}$
    
    d. $lim_{x\to 1}\frac{x-7}{\sqrt{x}+4}$
    
    e. $lim_{x\to 25}\frac{x-12}{\sqrt{x}-5}$
    
    f. $lim_{x\to 4}\frac{x-8}{\sqrt{x}-2}$
    
    g. $lim_{x\to 1}\frac{x-10}{\sqrt{x}+1}$
    
    h. $lim_{x\to 9}\frac{x-7}{\sqrt{x}+4}$
    
    i. $lim_{x\to 25}\frac{x-12}{\sqrt{x}-5}$
    

15. Resolver los siguientes lìmites

    a. $lim_{x\to 5}\frac{x-4}{\sqrt{x-4}-1}$
    
    b. $lim_{x\to 15}\frac{x-6}{\sqrt{x-6}-3}$
    
    c. $lim_{x\to 3}\frac{x-3}{\sqrt{x-3}}$
    
    d. $lim_{x\to 23}\frac{x-7}{\sqrt{x-7}-4}$
    
    e. $lim_{x\to 4}\frac{x-2}{\sqrt{x-2}-1}$
    
    f. $lim_{x\to 15}\frac{x-6}{\sqrt{x-6}-3}$
    
    g. $lim_{x\to 3}\frac{x-3}{\sqrt{x-3}}$
    
    h. $lim_{x\to 23}\frac{x-7}{\sqrt{x-7}-4}$
    
    i. $lim_{x\to 3}\frac{x-2}{\sqrt{x-2}-1}$


16. Resolver los siguientes lìmites


    a. $lim_{x\to 1}\frac{\sqrt{x+5}-2}{x-1}$
    
    b. $lim_{x\to 2}\frac{\sqrt{x+3}-4}{x-2}$
    
    c. $lim_{x\to 11}\frac{\sqrt{x+2}-5}{x-11}$
    
    d. $lim_{x\to 7}\frac{\sqrt{x+6}-1}{x-7}$
    
    e. $lim_{x\to 4}\frac{\sqrt{x+1}-6}{x-4}$
    
    f. $lim_{x\to 6}\frac{\sqrt{x+3}-4}{x-6}$
    
    g. $lim_{x\to 12}\frac{\sqrt{x+2}-5}{x-12}$
    
    h. $lim_{x\to 3}\frac{\sqrt{x+6}-1}{x-3}$
    
    i. $lim_{x\to 5}\frac{\sqrt{x+1}-6}{x-5}$

17. Resolver los siguientes lìmites

    a. $lim_{x\to 5}\frac{x+2}{x-1}$
    ...
    f. $lim_{x\to 2}\frac{x^2 + 2x - 3}{x-2}$
    
    g. $lim_{x\to -4}\frac{3x+4}{x+4}$
    
    h. $lim_{x\to 2}\frac{4x^2 - 5x - 6}{x-2}$
    
    i. $lim_{x\to 0}\frac{5x^2 + 6x}{x}$
    
    j. $lim_{x\to 1}\frac{x^3 - 3x^2 + 2x}{x-1}$
    

## Limites (segunda parte)
...
$lim_{x\to 0}\frac{2x}{3-x^2}$

$lim_{x\to -1}\frac{5x}{4-x^2}$

$lim_{x\to 2}\frac{x}{x^2-5}$

$lim_{x\to 3}\frac{4x}{5-x^2}$

$lim_{x\to -1}\frac{2x}{x^2-9}$

$lim_{x\to 0}\frac{3x}{x^2+1}$

$lim_{x\to -1}\frac{6x}{x^2-4}$


4. Resolver los siguientes lìmites

$lim_{x\to -1}\frac{x+3}{x^2-1}$

$lim_{x\to 2}\frac{x+4}{x^2-4}$

$lim_{x\to 4}\frac{x+1}{x^2-16}$

$lim_{x\to 2}\frac{x+5}{x^2-4}$

$lim_{x\to 6}\frac{x+6}{x^2-36}$

$lim_{x\to 5}\frac{x+4}{x^2-25}$

$lim_{x\to 3}\frac{x+2}{x^2-9}$

$lim_{x\to 8}\frac{x+5}{x^2-64}$

$lim_{x\to 9}\frac{x+6}{x^2-81}$
...
$lim_{x\to 2}\frac{\sqrt{4+x^2}}{x}$

$lim_{x\to 1}\frac{\sqrt{1+x^2}}{x}$

$lim_{x\to 0}\frac{\sqrt{3+x^2}}{x}$

$lim_{x\to -1}\frac{\sqrt{2+x^2}}{x}$

$lim_{x\to 4}\frac{\sqrt{5+x^2}}{x}$

$lim_{x\to 3}\frac{\sqrt{9+x^2}}{x}$

$lim_{x\to 1}\frac{\sqrt{1+x^2}}{x}$

$lim_{x\to 0}\frac{\sqrt{16+x^2}}{x}$
...
$lim_{x\to 0}\left(\frac{1}{x}-\frac{1}{x^3}\right)$

$lim_{x\to 0}\left(\frac{1}{x^2}-\frac{1}{x^4}\right)$

$lim_{x\to 0}\left(\frac{1}{x}-\frac{1}{x^4}\right)$
...
$lim_{x\to 0}\frac{3x^2-2x^3}{4x^3+x^2}$

$lim_{x\to 0}\frac{x^3-2x^2}{3x^4-5x^2}$

$lim_{x\to 0}\frac{x^4-4x^3}{5x^5-2x^2}$

$lim_{x\to 0}\frac{6x^3-5x^4}{x^2-3x^5}$

$lim_{x\to 0}\frac{x^3-6x^4}{2x^5+4x^2}$

$lim_{x\to 0}\frac{x^3-2x^4}{3x^5-5x^2}$

$lim_{x\to 0}\frac{x^4-4x^5}{5x^6-2x^3}$

$lim_{x\to 0}\frac{6x^3-5x^4}{x^2-3x^6}$

$lim_{x\to 0}\frac{x^4-6x^5}{2x^6+4x^3}$


9. Resolver los siguientes lìmites


$lim_{x\to 2}\left(\frac{1}{x}-\frac{3}{x^2-4}\right)$

$lim_{x\to 3}\left(\frac{2}{x+1}-\frac{4}{x^2-9}\right)$

$lim_{x\to 1}\left(\frac{5}{x-2}-\frac{2}{x^2-1}\right)$

$lim_{x\to -2}\left(\frac{1}{x+2}-\frac{2}{x^2-1}\right)$

$lim_{x\to -1}\left(\frac{4}{x+1}-\frac{1}{x^2-4}\right)$

$lim_{x\to -3}\left(\frac{2}{x+1}-\frac{4}{x^2-9}\right)$

$lim_{x\to 2}\left(\frac{5}{x-2}-\frac{2}{x^2-1}\right)$
...
$lim_{x\to 1}\frac{x^3+5x^2+6x}{x^2-3x+2}$

$lim_{x\to 3}\frac{x^3+8x^2+12x}{x^2-4x+3}$

$lim_{x\to 5}\frac{x^3+4x^2+3x}{x^2-2x-15}$

$lim_{x\to 2}\frac{x^3+10x^2+25x}{x^2-5x+6}$

$lim_{x\to 1}\frac{x^3+7x^2+10x}{x^2-3x+2}$

$lim_{x\to 3}\frac{x^3+8x^2+12x}{x^2-4x+3}$

$lim_{x\to -3}\frac{x^3+4x^2+3x}{x^2-2x-15}$

$lim_{x\to 2}\frac{x^3+10x^2+25x}{x^2-5x+6}$

$lim_{x\to 2}\frac{x^3+7x^2+10x}{x^2-3x+2}$
...
$lim_{x\to -5}\frac{3}{x^2+7x+10}$

$lim_{x\to 3}\frac{2}{x^2-6x+9}$

$lim_{x\to -4}\frac{4}{x^2+9x+20}$

$lim_{x\to 3}\frac{6}{x^2-0x+21}$

$lim_{x\to -5}\frac{7}{x^2+5x}$

$lim_{x\to 3}\frac{4}{x^2+4x-21}$

$lim_{x\to 9}\frac{2}{x^2+8x-9}$

$lim_{x\to 3}\frac{6}{x^2+8x-15}$

$lim_{x\to 0}\frac{7}{x^2+3x}$
...
$lim_{x\to 4}\frac{\sqrt{x}-3}{x-4}$

$lim_{x\to 2}\frac{\sqrt{x}-2}{x-4}$

$lim_{x\to 4}\frac{\sqrt{x}-2}{x^2-16}$

$lim_{x\to 1}\frac{\sqrt{x}+1}{x^2-1}$

$lim_{x\to 4}\frac{\sqrt{x}+2}{x^3-64}$

$lim_{x\to 4}\frac{\sqrt{x}-2}{x-4}$

$lim_{x\to 4}\frac{\sqrt{x}-2}{x^2-16}$

$lim_{x\to 4}\frac{\sqrt{x}+1}{x^2-12x+32}$

$lim_{x\to 4}\frac{\sqrt{x}+2}{x^2-64}$
...
$lim_{x\to -2}\frac{x^2+6x+9}{x+2}$

$lim_{x\to 1}\frac{x^2+3x+2}{x-1}$

$lim_{x\to -1}\frac{x^2+5x+6}{x+1}$

$lim_{x\to -4}\frac{x^2+2x+1}{x+4}$

$lim_{x\to -2}\frac{x^2+7x+12}{x+2}$
...
$lim_{x\to 16}\frac{x-11}{\sqrt{x}-4}$

$lim_{x\to 4}\frac{x-8}{\sqrt{x}-2}$

$lim_{x\to 1}\frac{x-10}{\sqrt{x}+1}$

$lim_{x\to 1}\frac{x-7}{\sqrt{x}+4}$

$lim_{x\to 25}\frac{x-12}{\sqrt{x}-5}$

$lim_{x\to 4}\frac{x-8}{\sqrt{x}-2}$

$lim_{x\to 1}\frac{x-10}{\sqrt{x}+1}$

$lim_{x\to 9}\frac{x-7}{\sqrt{x}+4}$
...
$lim_{x\to 5}\frac{x-4}{\sqrt{x-4}-1}$

$lim_{x\to 15}\frac{x-6}{\sqrt{x-6}-3}$

$lim_{x\to 3}\frac{x-3}{\sqrt{x-3}}$

$lim_{x\to 23}\frac{x-7}{\sqrt{x-7}-4}$

$lim_{x\to 4}\frac{x-2}{\sqrt{x-2}-1}$
...
$lim_{x\to 3}\frac{x-2}{\sqrt{x-2}-1}$
...
$lim_{x\to 2}\frac{\sqrt{x+3}-4}{x-2}$

$lim_{x\to 11}\frac{\sqrt{x+2}-5}{x-11}$

$lim_{x\to 7}\frac{\sqrt{x+6}-1}{x-7}$

$lim_{x\to 4}\frac{\sqrt{x+1}-6}{x-4}$

$lim_{x\to 6}\frac{\sqrt{x+3}-4}{x-6}$

$lim_{x\to 12}\frac{\sqrt{x+2}-5}{x-12}$

$lim_{x\to 3}\frac{\sqrt{x+6}-1}{x-3}$

$lim_{x\to 5}\frac{\sqrt{x+1}-6}{x-5}$
...
$lim_{x\to -3}\frac{2x+5}{x+3}$

$lim_{x\to 1}\frac{3x^2 - 4x - 3}{x-1}$
...
$lim_{x\to -4}\frac{3x+4}{x+4}$

$lim_{x\to 2}\frac{4x^2 - 5x - 6}{x-2}$

$lim_{x\to 0}\frac{5x^2 + 6x}{x}$
...
## Limites de funciones trigonométricas (reducida)
...
# 5. Derivadas
  ...
  1. [Ejercicios de Derivadas](https://github.com/ProfTodoMundo/NotasCalculoDiferencial/blob/PrincipalCD/docs/Derivadas.pdf)
  
  2. [Ejercicios de Derivadas - Primera Parte](https://github.com/ProfTodoMundo/NotasCalculoDiferencial/blob/PrincipalCD/docs/EjerciciosClaseDerivadasPte1.pdf). 
  
  3. [Ejercicios de Derivadas - Segunda Parte](https://github.com/ProfTodoMundo/NotasCalculoDiferencial/blob/PrincipalCD/docs/DerivadasSegundaParte.pdf).
  
  4. [Ejercicios de Derivadas - Tercera Parte](https://github.com/ProfTodoMundo/NotasCalculoDiferencial/blob/PrincipalCD/docs/DerivadasTerceraParte.pdf).
  
  5. [Regla de la Cadena - Primera Parte](https://github.com/ProfTodoMundo/NotasCalculoDiferencial/blob/PrincipalCD/docs/DerivadasReglaCadena.pdf).
  
  6. [Regla de la Cadena - Segunda Parte](https://github.com/ProfTodoMundo/NotasCalculoDiferencial/blob/PrincipalCD/docs/DerivadasReglaCadenaPt2.pdf).
  
7. [Derivada Implícita](https://github.com/ProfTodoMundo/NotasCalculoDiferencial/blob/PrincipalCD/docs/.pdf).  
...
## Puntos Críticos y valores extremos
 ...
 1. [Determinación de Máximos, Mínimos, Criterio de la Primera y Segunda Derivada](https://github.com/ProfTodoMundo/NotasCalculoDiferencial/blob/PrincipalCD/docs/AplicacionesDerivadaPrimeraParte.pdf)


# Anexo 1. Evaluaciones y Tareas
## A.  Tarea 1
...
## B. Simulador de Primer evaluación parcial

Para resolver el simulador de evaluación descarga [aquí](https://github.com/ProfTodoMundo/NotasCalculoDiferencial/blob/PrincipalCD/docs/PropuestaExamen1.pdf).

    Recuerda que debes de incluir todas tus operaciones realizadas en una hoja aparte y que cuentas con una hora y media para realizarla.
...
1. Resolver las siguientes ecuaciones de primer grsdo
    ...
    a. $\frac{11}{12}x + \frac{10}{11} = -\frac{9}{10}$ \textbf{ 1 pto.}
    
    c. $\frac{3}{4}-\left\{\frac{6}{7}[\frac{5}{6}(\frac{3}{4}x-\frac{4}{5})+\frac{7}{8}(\frac{2}{3}x-\frac{5}{6})-\frac{1}{2}]\right\}=\frac{9}{10}(\frac{4}{5}x+\frac{6}{7})-\frac{1}{3}+\frac{4}{5}x$ \textbf{ 2.5 ptos.}
        

2. Resolver las siguientes desigualdades de primer grado
    
    a. $-2x+1>5x-8$ \textbf{ 0.5 pto.}
    
    c. $-\frac{1}{2}x+\frac{3}{4}<\frac{3}{5}x+\frac{1}{10}$  \textbf{ 1.5 ptos.}
    

3. Resolver las siguientes desigualdades dobles
    
    a. $1<\frac{1}{2}x+\frac{1}{3}\leq 2$  \textbf{ 1.5 ptos.}
    

4. Resolver las siguientes desigualdades de valor absoluto

    
    a. $|2x+1|<6$   \textbf{ 2 ptos.}

    c. $|-\frac{1}{4}x-\frac{1}{8}| \leq \frac{3}{4}$\textbf{ 2 ptos.}
        


5. Resolver las siguentes desigualdades de segundo grado

    a. $2x^2-7x+6>0$ \textbf{ 2 ptos.}
    
    c. $-4x^2+16x-12<0$\textbf{ 2 ptos.}
...
Para descargar la tarea [aquí](https://github.com/ProfTodoMundo/NotasCalculoDiferencial/blob/PrincipalCD/docs/Tarea2.pdf).

## E. Evaluaciones

- [Segunda Evaluación Parcial](https://github.com/ProfTodoMundo/NotasCalculoDiferencial/blob/PrincipalCD/docs/SegundaEvaluacionParcial.pdf)

- [Tercera Evaluación Parcial](https://github.com/ProfTodoMundo/NotasCalculoDiferencial/blob/PrincipalCD/docs/TerceraEvaluacionParcial.pdf)

- [Cuarta Evaluación Parcial](https://github.com/ProfTodoMundo/NotasCalculoDiferencial/blob/PrincipalCD/docs/CuartaEvaluacionParcial.pdf)

# Anexo 2. Tema Adicionales
...
## D. Elementos básicos de Trigonometría
...
# Define el intervalo y la cantidad de puntos
t <- 2  # Puedes ajustar este valor según tus necesidades
h <- 2  # Ajusta el valor de h según tus necesidades
x <- seq(-2 * pi * t, 2 * pi * t, length.out = 1000)  # Intervalo y cantidad de puntos
...
t <- 2  # Puedes ajustar este valor según tus necesidades
h <- 2  # Ajusta el valor de h según tus necesidades
r <- 2  # Ajusta el valor de r según tus necesidades
x <- seq(-2 * pi * t, 2 * pi * t, length.out = 1000)  # Intervalo y cantidad de puntos
...
h <- 2  # Ajusta el valor de h según tus necesidades
r <- 2  # Ajusta el valor de r según tus necesidades
k <- 2  # Ajusta el valor de k según tus necesidades
x <- seq(-2 * pi * t, 2 * pi * t, length.out = 1000)  # Intervalo y cantidad de puntos
